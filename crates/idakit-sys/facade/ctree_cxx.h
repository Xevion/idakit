...
// include!) to declare it; the generated glue and the hand-written driver in ctree_cxx.cc both
// include it.
#pragma once
...
// name it by reference; ctree_cxx.cc includes the generated header for the full class.
struct CtreeVisitor;
