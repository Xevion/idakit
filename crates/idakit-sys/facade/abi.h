...
/* The zero-copy read into a caller buffer, <0 on fail. `ea` is IDA's ea_t (64-bit under __EA64__).
 * The owning twin (Vec), pattern search, and patching are cxx bridges in the generated bytes
 * domain. */
int64_t idakit_get_bytes(uint64_t ea, void *buf, size_t size);
